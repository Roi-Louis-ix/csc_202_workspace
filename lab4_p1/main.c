...
int main(void)
{
  ...
  for(uint8_1 loop_cntr = 0; loop_cntr < 10; loop_cntr++)
  {
    ...
    msec_delay(200);
    GPIOB->DOUT31_0 &= ~GPIO_DOUT31_0_DIO13_MASK;
    GPIOA->DOUT31_0 |= GPIO_DOUT31_0_DIO12_MASK;
    msec_delay(200);
    GPIOA->DOUT31_0 &= ~GPIO_DOUT31_0_DIO12_MASK;
    GPIOA->DOUT31_0 |= GPIO_DOUT31_0_DIO13_MASK;
    msec_delay(200);
    GPIO->DOUT31_0 &= ~GPIO_DOUT31_0_DIO13_MASK;
    GPIOA->DOUT31_0 |= GPIO_DOUT31_0_DIO16_MASK;
    msec_delay(200);
    GPIO->DOUT31_0 &= ~GPIO_DOUT31_0_DIO16_MASK;
    GPIOA->DOUT31_0 |= GPIO_DOUT31_0_DIO17_MASK;
    msec_delay(200);
    GPIO->DOUT31_0 &= ~GPIO_DOUT31_0_DIO17_MASK;
  }
